...
| `docs/BOOK_LIBRARY.md` | Book mode round three. Phase L-0 = promises the app already makes and does not keep | L1…L12 | L1…L10 **done** — Phase L-0 closed; L11, L12 pending |
