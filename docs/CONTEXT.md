...
shipped as `SHAKEDOWN.md` S5 (#TBD)** and the archive's status line was left as
...
**`docs/SHAKEDOWN.md` has nothing buildable left.** S5 shipped (#TBD) and every
...
(#191), S3 (#192), S6 (#193) and S5 (#TBD) followed, and the last four were built
...
**The suite is 271 tests, 19 classes as of #TBD** (S5 added 15). A cloud container
