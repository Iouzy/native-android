...
| `docs/BOOK_LIBRARY.md` | Book mode round three. Phase L-0 = promises the app already makes and does not keep | L1…L12 | L1…L5 **done** — Phase L-0 closed; L6…L12 pending |
