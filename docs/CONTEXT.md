...
|---|---|---|---|
| `docs/FIRST_RUN.md` | The edges: the permission never asked for, the empty screens, the front doors. Written from a device run, 2026-08-03 | N1…N8 | N1…N4 **done**; N5…N8 pending |
