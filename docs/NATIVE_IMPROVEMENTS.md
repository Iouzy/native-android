...
### T1 · Midnight ticker — Status: in-progress (PR #127)
...
2026-06-19 · T1 · #127 · midnight ticker: replaced 30s while(true) poll with delay(until next local midnight + 1s); ON_RESUME in MainScaffold already covers doze/clock changes; runRollover semantics unchanged
