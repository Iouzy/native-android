...
## N7 · One way to start a block — Status: done (PR #187, duplication reading)
...
## N8 · The book form asks nine questions — Status: done (PR #187)
