...
## S5 · F7's leftover: "página 123 de 228" — Status: done (PR #TBD)
...
S6  ──────────────  done (#193) — the hypothesis was not proved, only acted on
 │
S5  ──────────────  done (#TBD) — F7's leftover is closed; no book has been opened
 │
